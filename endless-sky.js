...
var ASM_CONSTS = {
 ...
 379998: ($0) => { if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } },  
 380081: () => { if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; } },  
 380150: () => { return window.innerWidth; },  
 380180: () => { return window.innerHeight; }
};
